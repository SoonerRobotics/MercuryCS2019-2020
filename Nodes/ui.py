...
import threading, argparse, datetime, imutils, time, random, copy, base64, socketserver, json
...
def main():
	...
	def fetch_sensors():
		...
		with lock:
			...
			sensor_dict["us_front"] = str(random.randint(0,100))
			sensor_dict["us_left"] = str(random.randint(0,100))
			sensor_dict["us_right"] = str(random.randint(0,100))
